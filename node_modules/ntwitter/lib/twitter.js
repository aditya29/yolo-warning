...
/*Twitter.prototype.replyToStatus = function(text, status_id, params, callback) {
  if (typeof params === 'function') {
    callback = params;
    params = null;
  }
  ...
  var defaults = {
    status: text,
    include_entities: 1
    in_reply_to_status_id: JSON.stringify(status_id),
  };
...
Twitter.prototype.replyToStatus = function(text, status_id, user_name, params, callback) {
  if (typeof params === 'function') {
    callback = params;
    params = null;
  }
  ...
  var defaults = {
    ...
    in_reply_to_status_id_str: String(status_id)
